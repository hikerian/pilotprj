...
import example.djl.utils.Arguments;


/**
 * An example of training an image classification (MNIST) model.
 *
 * <p>See this <a href="https://github.com/deepjavalibrary/djl/blob/master/examples/docs/train_mnist_mlp.md">doc</a>
...
public class TrainMnist {
	...
	private static RandomAccessDataset getDataset(Dataset.Usage usage, Arguments arguments) throws IOException {
		Mnist mnist = Mnist.builder().optUsage(usage)
